...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 1dfWj3ktJsL/css
...
function PlasmicTextInput__RenderFunc(props: {
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          placeholder: "tell us your ingredients!"
        },
        props.args
      ),
    [props.args]
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__zOjl)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___1Eowk)}
              role={"img"}
            />
          ),
